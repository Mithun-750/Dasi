...
class Settings:
    def __init__(self):
        ...
        self.config_dir = Path(os.getenv('XDG_CONFIG_HOME', Path.home() / '.config')) / 'dasi'
...
class SettingsWindow(QMainWindow):
    ...
    def save_and_launch(self):
        ...
        if not api_key:
            QMessageBox.warning(self, "Error", "Please enter your Google API key.")
            return
