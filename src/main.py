...
from ui.popup import DasiWindow, UISignals
from llm_handler import LLMHandler
from ui.settings import Settings, SettingsWindow
from PyQt6.QtWidgets import QApplication, QSystemTrayIcon, QMenu
from PyQt6.QtGui import QIcon, QPixmap, QPainter, QClipboard
...
class CopilotUI:
    def _show_window(self, x: int, y: int):
        ...
        try:
            ...
            self.window.input_field.clear_text()
    ...
    def __init__(self, process_query):
        ...
        self.window = DasiWindow(self.process_query, self.signals, self.settings)
